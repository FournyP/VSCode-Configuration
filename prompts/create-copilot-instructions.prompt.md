...
${PROJECT_TYPE="Auto-detect|Golang|.NET|JavaScript|TypeScript|React|Multiple|Other"} <!-- Primary technology -->
${ARCHITECTURE_STYLE="Hexagonal|Microservices|Monolithic|Domain-Driven|Event-Driven|Serverless|Mixed|Multiple|Other"} <!-- Architectural approach -->
